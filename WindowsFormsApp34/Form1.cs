...

{
    public partial class Form1 : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            using (SqlConnection connection = new SqlConnection(@"Data Source=DESKTOP-V17FJUF\SQLEXPRESS;Initial Catalog=calculator;User Id=DESKTOP-V11FJUF\Admin;Integrated Security=True;"))
            {
                connection.Open();
